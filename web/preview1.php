...
<?php } ?><a href="finish_magazine_cover.php?title=<?php echo $magazine_name;?>&&
maintext=<?php echo $magazine_name; ?>&&image=<?php echo $target_file;?>&&design_id=<?php echo $design_id; ?>" class="btn waves-effect waves-light btn-info hidden-md-down"> Finish And Start Magazine Pages </a>
<?php 
