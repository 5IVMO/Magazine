                ...
                <div class="row">
                 <!--    <div class="col-12">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <p style="text-align: left;"> Magazine Step 2</p>
                                </div>
                             </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                     <p style=" text-align: left; "> You choosen design id : <?php echo $design_id; ?> </p> 
                                </div>
                ...
                <div class="row" style="margin-left: 20px">
                    ...
                    <div class="col-6">
                       <div class="card card-box">
                            ...
                            <textarea id = "area" name="area1" cols="40" rows="5" onkeyup="limitText(10);"></textarea>
                           ...
                           <span style="margin-left: 30px">
                            ...
                            <input type="file" class="btn btn- btn-sm" name="background_image"  accept="image/x-png,image/jpeg">
                           </span><br><br>
